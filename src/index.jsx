...
class Navbar extends Component {
  ...
  render() {
    return (
        <nav id="APP_NAV" class="navigation">
          <Link activeclass="active" href="/" aria-label="Read more about..">
            <svg id="icon-home" viewBox="0 0 32 32">
              <path d="M32 19l-6-6v-9h-4v5l-6-6-16 16v1h4v10h10v-6h4v6h10v-10h4z" />
            </svg>
          </Link>
          <Link activeclass="active" href="/about" aria-label="Read more about..">
          ...
          <Link activeclass="active" href="/contact" aria-label="Read more about..">
            <svg id="icon-location" viewBox="0 0 32 32">
              <path d="M16 0c-5.523 0-10 4.477-10 10 0 10 10 22 10 22s10-12 10-22c0-5.523-4.477-10-10-10zM16 16c-3.314 0-6-2.686-6-6s2.686-6 6-6 6 2.686 6 6-2.686 6-6 6z" />
            </svg>
          </Link>
          <Link activeclass="active" href="/more" aria-label="Read more about..">
